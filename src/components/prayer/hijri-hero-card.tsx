...
export function HijriHeroCard() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 px-6 text-center space-y-2 w-full bg-card border border-border shadow-lg rounded-3xl overflow-hidden relative">
      ...
      >
        ...
        <span className="text-xl font-heading font-medium text-primary/80 mt-1">
          {hijri.year} AH
        </span>
      </motion.div>
    </div>
